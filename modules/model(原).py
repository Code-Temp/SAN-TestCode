...
class Model(nn.Module):
    ...
    def __init__(self, config):
        super().__init__()
        if config.dataset_if_radical_language_model==False:
            print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
            print('if_radical_language_model=False')
            print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
            ...
            print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
            print('if_radical_language_model=True')
            print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
            self.max_length = config.dataset_max_length_radical + 1
            self.charset = CharsetMapper(config.dataset_charset_path_radical, max_length=self.max_length)
